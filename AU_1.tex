...
\date{May 23rd, 2019}%[Big Data Workshop]
%\date{\today}
...
\begin{itemize}
\item[1)] 5/23, Morning: Acquiring, preprocessing, and comparing text
\item[2)] 5/23, Afternoon: \textbf{Discovery}: Vector Space Model of Text, Clustering Methods, Topic Models, Separating Words
\item[3)] 5/24, Morning: \textbf{Measurement}: Dictionary Methods, Hand Coding, Supervised Methods Part 1
\item[4)] 5/24, Afternoon: \textbf{Causal Inference}: Train/Test Split, Analyst Induced SUTVA, Text as Dependent and Independent Variable
\end{itemize}
...
\invisible<1-4>{Exercise: Scraping a Presidential Speech: HW1 on the github :
\begin{itemize}
